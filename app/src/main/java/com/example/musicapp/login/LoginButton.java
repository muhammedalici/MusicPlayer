...
import com.example.musicapp.OnButtonSwitchedListener;
...
//        signUpPaint.setAlpha(255);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        loginPaint.getTextBounds(getString(R.string.sign_up), 0, 6, r);
        ...
        signUpPaint.getTextBounds(getString(R.string.sign_up), 0, 6, signUpTextOutline);
        ...
        orPaint.getTextBounds(getContext().getString(R.string.or).toUpperCase(), 0, 4, r);
