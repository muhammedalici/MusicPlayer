...
public class LikedSongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Users")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("LikedSongs");
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                initializeData(dataSnapshot);

                RecyclerView myrv = (RecyclerView) findViewById(R.id.recycle_activity_likedsongs);
                RecyclerViewVertical myAdapter = new RecyclerViewVertical(LikedSongsActivity.this,likedList);
                GridLayoutManager lLayout = new GridLayoutManager(LikedSongsActivity.this, 1);
    ...
    private void menu() {
        ImageView back=findViewById(R.id.liked_back_finish);
        ...
        TextView textMenu= findViewById(R.id.bt_liked_txt);
        textMenu.setTextColor(Color.parseColor("#f05408"));


        liked.setBackgroundResource(R.drawable.ic_favorite_orange_24dp);

        recmd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LikedSongsActivity.this,RecmmdSongsActivity.class);
                startActivity(i);
            }
        });
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LikedSongsActivity.this,PlayMusicActivity.class);
