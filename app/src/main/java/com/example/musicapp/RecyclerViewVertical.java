...
public class RecyclerViewVertical extends RecyclerView.Adapter<RecyclerViewVertical.MyViewHolder> {
    ...
    public RecyclerViewVertical(Context mContext, List<Model_musicNamePic> mData)  {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.card_sarki_list_vertical,parent,false);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            image=itemView.findViewById(R.id.card_vert_img);
            title=itemView.findViewById(R.id.card_vert_txt);
            cardView = (CardView) itemView.findViewById(R.id.card_vert_card);
